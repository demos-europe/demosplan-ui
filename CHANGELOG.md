...
- ([#651](https://github.com/demos-europe/demosplan-ui/pull/651)) Move Components from /Core/ folder to root ([@ahmad-demos](https://github.com/@ahmad-demos))
- ([#640](https://github.com/demos-europe/demosplan-ui/pull/640)) Fix resetContent in DpEditor ([@salis-demos](https://github.com/salis-demos))
