...
### Changed
- ([#1555](https://github.com/demos-europe/demosplan-ui/pull/1555)) DpModal: add a footer slot and a grey divider between sections ([@sakutademos](https://github.com/sakutademos))
