...
- ([#919](https://github.com/demos-europe/demosplan-ui/pull/919)) Add enlarging images on click for DpDataTable and DpEditor ([@gruenbergerdemos](https://github.com/gruenbergerdemos))
