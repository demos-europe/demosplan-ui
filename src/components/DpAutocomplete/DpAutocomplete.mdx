...
<Canvas of={DpAutocompleteStories.WithoutSearchButton} />
...
This component follows **WCAG 2.1 AA** guidelines with proper ARIA attributes for autocomplete functionality:
...
- `aria-haspopup="listbox"` and `aria-controls` indicate the relationship between input and suggestions
