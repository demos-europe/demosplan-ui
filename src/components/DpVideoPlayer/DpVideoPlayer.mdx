...
The VideoPlayer component is used to add Video content. It includes controls for play/pause, sound volume,
playback speed, a download link, and a fullscreen view. The player uses [Plyr](https://github.com/sampotts/plyr) under the hood.
