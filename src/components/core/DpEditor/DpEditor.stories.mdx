...
The slot `modal` can be used to add a modal component to DpEditor.

The function `handleInsertText` is exposed to the `modal` slot to enable the modal component to add text to the editor instance.
