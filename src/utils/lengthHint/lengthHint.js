...
const exactlengthHint = (currentLength, requiredLength) => {
  ...
  return reqLength
    ? Translator.trans('input.text.exactlength.short', {
      ...
      count: currentLength,
      class: (currentLength === reqLength) ? 'color-ui-status-progress-text' : 'color-ui-status-failed-text'
    })
    : ''
}
...
const maxlengthHint = (currentLength, maxlength) => {
  ...
  return max
    ? Translator.trans('input.text.maxlength.short', {
      ...
      class: (max - currentLength > errorThreshold) ? 'color-ui-status-progress-text' : 'color-ui-status-failed-text'
    })
    : ''
}
...
const minlengthHint = (currentLength, minlength) => {
  ...
  return min
    ? Translator.trans('input.text.minlength.short', {
      ...
      class: (min <= currentLength) ? 'color-ui-status-progress-text' : 'color-ui-status-failed-text'
    })
    : ''
}
