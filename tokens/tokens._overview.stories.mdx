...
## Applying Design Tokens as Tailwind Utility Classes and SCSS Variables

Tokens can be utilized through Tailwind Utility Classes and SCSS Variables. As we're currently migrating to Tailwind,
not all tokens are already available as Tailwind classes.

<Table
  headers={['Token', 'Scss Variable', 'Tailwind Utility Class']}
  rows={[
    ["Border Radius", "✔", "✔"],
    ["Box Shadow", "✔", "✔"],
    ["Breakpoints", "✔", "✔"],
