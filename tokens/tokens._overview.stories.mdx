...
*Namespace* is always "dp", *Category* being "color", "space", or "font-size", *Domain* being "brand" or "data" ("ui"
and "palette" domains are omitted for the sake of readability). *Concept/Element* can be either a color name
(in palette colors), or a concept the token applies to (like "main" in brand tokens, or "interactive" in ui tokens).
