...
import ColorModule from '../.storybook/components/ColorModule'
...
<ColorModule module={'color'} />

#### Text colors

<ColorModule module={'textColor'} />

#### Background colors

<ColorModule module={'backgroundColor'} />

#### Border colors

<ColorModule module={'borderColor'} />
